...
class appProdProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('jquery_js' => array(0 => array(0 => (dirname(dirname(__DIR__)).'/../components/jquery/jquery.min.js')), 1 => array(0 => '?yui_js'), 2 => array()), 'bootstrap_js' => array(0 => array(0 => (dirname(dirname(__DIR__)).'/../vendor/twitter/bootstrap/js/transition.js'), 1 => (dirname(dirname(__DIR__)).'/../vendor/twitter/bootstrap/js/alert.js'), 2 => (dirname(dirname(__DIR__)).'/../vendor/twitter/bootstrap/js/modal.js'), 3 => (dirname(dirname(__DIR__)).'/../vendor/twitter/bootstrap/js/dropdown.js'), 4 => (dirname(dirname(__DIR__)).'/../vendor/twitter/bootstrap/js/scrollspy.js'), 5 => (dirname(dirname(__DIR__)).'/../vendor/twitter/bootstrap/js/tab.js'), 6 => (dirname(dirname(__DIR__)).'/../vendor/twitter/bootstrap/js/tooltip.js'), 7 => (dirname(dirname(__DIR__)).'/../vendor/twitter/bootstrap/js/popover.js'), 8 => (dirname(dirname(__DIR__)).'/../vendor/twitter/bootstrap/js/button.js'), 9 => (dirname(dirname(__DIR__)).'/../vendor/twitter/bootstrap/js/collapse.js'), 10 => (dirname(dirname(__DIR__)).'/../vendor/twitter/bootstrap/js/carousel.js'), 11 => (dirname(dirname(__DIR__)).'/../vendor/twitter/bootstrap/js/affix.js')), 1 => array(0 => '?yui_js'), 2 => array()), 'bootstrap_less' => array(0 => array(0 => (dirname(dirname(__DIR__)).'/../vendor/twitter/bootstrap/less/bootstrap.less')), 1 => array(0 => 'lessphp', 1 => 'cssembed'), 2 => array()))), 'config');
    ...
    {
        $this->services['assetic.filter.cssembed'] = $instance = new \Assetic\Filter\CssEmbedFilter((dirname(dirname(__DIR__)).'/Resources/java/cssembed-0.4.5.jar'), '/usr/bin/java');
    ...
    {
        $this->services['assetic.filter.yui_js'] = $instance = new \Assetic\Filter\Yui\JsCompressorFilter((dirname(dirname(__DIR__)).'/Resources/java/yuicompressor.jar'), '/usr/bin/java');
        $instance->setCharset('UTF-8');
        $instance->setTimeout(NULL);
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony_survey', 'user' => 'root', 'password' => 'passIT42XKZ-0', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_8fdd9db3124c4f42820027dd00090357');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_8fdd9db3124c4f42820027dd00090357');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_8fdd9db3124c4f42820027dd00090357');
        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => (dirname(dirname(dirname(__DIR__))).'/src/CeisSurvey/Bundle/UsersBundle/Entity'))), 'CeisSurvey\\Bundle\\UsersBundle\\Entity');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler((dirname(dirname(__DIR__)).'/logs/prod.log'), 100, true);
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/CeisSurvey/Bundle/UsersBundle/Resources/views'), 'CeisSurveyUsers');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Girish/Bundle/CrudBundle/Resources/views'), 'GirishCrud');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), (dirname(dirname(__DIR__)).'/../web'), false);
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'))), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GirishCrudBundle' => 'Girish\\Bundle\\CrudBundle\\GirishCrudBundle',
            ),
            ...
            'router.resource' => (dirname(dirname(__DIR__)).'/config/routing.yml'),
            ...
            'assetic.filter.cssembed.jar' => (dirname(dirname(__DIR__)).'/Resources/java/cssembed-0.4.5.jar'),
            ...
            'assetic.filter.yui_js.jar' => (dirname(dirname(__DIR__)).'/Resources/java/yuicompressor.jar'),
