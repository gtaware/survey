...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('jquery_js' => array(0 => array(0 => ($this->targetDirs[2].'/../components/jquery/jquery.min.js')), 1 => array(0 => '?yui_js'), 2 => array()), 'bootstrap_js' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twitter/bootstrap/js/transition.js'), 1 => ($this->targetDirs[2].'/../vendor/twitter/bootstrap/js/alert.js'), 2 => ($this->targetDirs[2].'/../vendor/twitter/bootstrap/js/modal.js'), 3 => ($this->targetDirs[2].'/../vendor/twitter/bootstrap/js/dropdown.js'), 4 => ($this->targetDirs[2].'/../vendor/twitter/bootstrap/js/scrollspy.js'), 5 => ($this->targetDirs[2].'/../vendor/twitter/bootstrap/js/tab.js'), 6 => ($this->targetDirs[2].'/../vendor/twitter/bootstrap/js/tooltip.js'), 7 => ($this->targetDirs[2].'/../vendor/twitter/bootstrap/js/popover.js'), 8 => ($this->targetDirs[2].'/../vendor/twitter/bootstrap/js/button.js'), 9 => ($this->targetDirs[2].'/../vendor/twitter/bootstrap/js/collapse.js'), 10 => ($this->targetDirs[2].'/../vendor/twitter/bootstrap/js/carousel.js'), 11 => ($this->targetDirs[2].'/../vendor/twitter/bootstrap/js/affix.js')), 1 => array(0 => '?yui_js'), 2 => array()), 'bootstrap_less' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twitter/bootstrap/less/bootstrap.less')), 1 => array(0 => 'lessphp', 1 => 'cssembed'), 2 => array()))), 'config');
    ...
    {
        $this->services['assetic.filter.cssembed'] = $instance = new \Assetic\Filter\CssEmbedFilter(($this->targetDirs[2].'/Resources/java/cssembed-0.4.5.jar'), '/usr/bin/java');
    ...
    {
        $this->services['assetic.filter.yui_js'] = $instance = new \Assetic\Filter\Yui\JsCompressorFilter(($this->targetDirs[2].'/Resources/java/yuicompressor.jar'), '/usr/bin/java');
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('cssrewrite' => 'assetic.filter.cssrewrite', 'cssembed' => 'assetic.filter.cssembed', 'yui_js' => 'assetic.filter.yui_js', 'lessphp' => 'assetic.filter.lessphp'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'sf_demo_survey', 'user' => 'root', 'password' => 'passIT42XKZ-0', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_6f9e0d9f3025f8e30ba5d780036a1b85');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_6f9e0d9f3025f8e30ba5d780036a1b85');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_6f9e0d9f3025f8e30ba5d780036a1b85');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/CeisSurvey/Bundle/UsersBundle/Entity'))), 'CeisSurvey\\Bundle\\UsersBundle\\Entity');
        ...
        $e->setEntityNamespaces(array('CeisSurveyUsersBundle' => 'CeisSurvey\\Bundle\\UsersBundle\\Entity'));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'paris9292');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('CeisSurvey\\Bundle\\UsersBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('CeisSurvey\\Bundle\\UsersBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('CeisSurvey\\Bundle\\UsersBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('CeisSurvey\\Bundle\\UsersBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'CeisSurvey\\Bundle\\UsersBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $h, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($h, '/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $i->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $j = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($h, array('always_use_default_target_path' => false, 'default_target_path' => '/profile', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $j->setProviderKey('main');

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($g, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => $i, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $h, 'main', $j, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $h, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '54e20d8941ee8', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $g, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $h, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $h, '/login', false), NULL, NULL, $a));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/CeisSurvey/Bundle/UsersBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'cache' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => array(0 => 'Symfony\\Bundle\\TwigBundle\\TwigDefaultEscapingStrategy', 1 => 'guess'), 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/CeisSurvey/Bundle/UsersBundle/Resources/views'), 'CeisSurveyUsers');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('paris9292');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CeisSurveyUsersBundle' => 'CeisSurvey\\Bundle\\UsersBundle\\CeisSurveyUsersBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'sf_demo_survey',
            'database_user' => 'root',
            'database_password' => 'passIT42XKZ-0',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                ...
                2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/config/validation/orm.xml'),
            ),
            ...
            'assetic.filter.cssembed.jar' => ($this->targetDirs[2].'/Resources/java/cssembed-0.4.5.jar'),
            ...
            'fos_user.model.user.class' => 'CeisSurvey\\Bundle\\UsersBundle\\Entity\\User',
